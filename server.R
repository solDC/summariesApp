      ...
      if(typeUser() == "expert"){
        ...
        tabItems(
          tabItem(tabName = "information",
                  ...
                  br(),
                  h4("El objetivo de esta herramienta es ",strong("validar resúmenes generados automáticamente"), "por un modelo que adapta al español 
                    técnicas de aprendizaje profundo basadas en Transformers. "),
                  br(),
                  h4(strong("El trabajo de validación de un resumen consta en leer la noticia y luego el resumen que ha generado el modelo. A continuación, 
                         deberá contestar un máximo de 3 preguntas"),"."),
                  br(),
                  h4(strong("Para enviar sus respuestas, "),"deberá guarda la validación haciendo ",strong("click en el botón <<Guardar Validación>>")),
                  br(),
                  h4("Este proceso se repite para todos los resúmenes de la lista."),
                  br(),
                  br(),
                  img(src = "pasosValidacion.png",width="100%"),
          ),
